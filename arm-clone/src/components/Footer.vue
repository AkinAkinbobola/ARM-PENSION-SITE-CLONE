<template>
    <div class="bg-footerBlack text-white flex py-14 px-10">
        <div class="flex flex-col w-2/5 mr-14">
            ...
            <p class="text-sm font-sans mb-1">+234 1 3305000(Call Centre)</p>
            <p class="text-sm font-sans mb-1">+234 1 4650000(Call Centre)</p>
            <p class="text-sm font-sans mb-1">0700CALLARM (07002255276) Call Centre</p>
            <a href="#" class="text-footerGrey hover:underline text-sm mb-1">Make a complaint</a>
            <a href="#" class="text-footerGrey hover:underline text-sm mb-1">Find a branch</a>
            <a href="#" class="text-footerGrey hover:underline text-sm mb-1">Privacy Policy</a>
            <a href="#" class="text-footerGrey hover:underline text-sm mb-1">Cookie Policy</a>
        </div>
